...
export default function SelfTest({ subjects }) {
    return (
        <AppLayout>
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4">
                    ...
                    <div className="text-center mb-16 relative">
                        ...
                        <p className="md:text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed font-light">
                            নিজেকে যাচাই করো
                            <span className="text-[#FF014F] font-medium"> আত্মবিশ্বাস গড়ে তোলো  </span>
                        </p>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {subjects.map((subject) => (
                            <Link 
                                href={`/self-test/${subject.id}`} 
                                key={subject.id}
                                className="group relative bg-[#d5d5d50f] backdrop-blur-sm rounded overflow-hidden shadow-2xl  cursor-pointer transition-all duration-500 hover:transform hover:-translate-y-2"
                            >
                                {/* Background Pattern */}
                                ...
                                <div className="relative p-6">
                                    ...
                                    <div className="relative mb-4">
                                        <div className="w-20 h-20 mx-auto bg-gradient-to-br from-[#FF014F]/20 to-[#FF014F]/10 rounded-2xl flex items-center justify-center group-hover:from-[#FF014F]/30 group-hover:to-[#FF014F]/20 transition-all duration-500 border border-[#FF014F]/20 group-hover:scale-110">
                                            <img 
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-gray-400 text-sm mb-4">
                                            {subject.questions_count || 'Multiple'} Questions
                                        </p>
                    ...
                    {subjects.length === 0 && (
                        <div className="text-center py-12">
                            <div className="text-gray-400 text-lg">No subjects available for self-testing</div>
                        </div>
                    )}
                </div>
