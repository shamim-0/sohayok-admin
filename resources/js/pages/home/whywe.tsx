...
export default function WhyChoseUs({ whywe }) {
    const [features, setFeatures] = useState([]);

    useEffect(() => {
        if (whywe && whywe.features) {
            setFeatures(whywe.features);
        }
    }, [whywe]);


    const stats = whywe?.stats;
            ...
            <section className="relative overflow-hidden bg-[#0a0a0a] py-20">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4">
                    ...
                    <div className="text-center mb-16 relative">
                        ...
                        <h2 className=" md:text-5xl font-bold mb-6 leading-tight">
                            <span className="relative text-white">
                                {whywe?.title_part_1 || "কেন আমাদের"}
                            </span>
                            <span className="ms-3 bg-gradient-to-r from-[#FF014F] via-[#FF014F] to-[#FF014F] bg-clip-text text-transparent mt-4">
                                {whywe?.title_part_2 || "বেছে নিবেন?"}
                            </span>
                        </h2>

                        <p className="md:text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed font-light">
                            {whywe?.subtitle_part_1 || "আপনার শিক্ষার যাত্রাকে অসাধারণ করে তুলতে আমরা যা অফার করি"}
                            <span className="text-[#FF014F] font-medium">{whywe?.subtitle_part_2 || "এক্সপার্ট-লেড, ইন্ডাস্ট্রি ফোকাসড।"}</span>
                        </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
                        {features.map((feature, index) => (
                            <div
                                ...
                                className="group relative bg-[#77767611] backdrop-blur-sm rounded overflow-hidden shadow-2xl  border-[#FF014F]/20 hover:border-[#FF014F]/40 transition-all duration-500  cursor-pointer p-8"
                            >
                                {/* Status Indicator */}
                                ...
                                <div className="text-center">
                                    <h3 className="text-xl font-bold text-white mb-4 group-hover:text-[#FF014F] transition-colors duration-300">
                                        {feature.title}
                                    </h3>
                    ...
                    {/* Stats Section */}
                    <div className="bg-gradient-to-r from-[#433a3d1e] to-[#dad7d809] backdrop-blur-sm rounded  border-[#FF014F]/20 p-8 md:p-12 mb-16">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                            {stats.map((stat, index) => (
                                <div key={index} className="text-center group">
                                    <div className="text-3xl md:text-4xl font-bold text-[#FF014F] mb-2 group-hover:scale-110 transition-transform duration-300">
                                        {stat.number}
                                    </div>
                                    ...
                                    {/* Animated underline */}
                                    <div className="w-8 h-0.5 bg-gradient-to-r from-[#FF014F] to-transparent rounded-full mx-auto mt-3 transform transition-all duration-300 group-hover:w-12 group-hover:bg-[#FF014F]"></div>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    {/* CTA Section */}
                    <div className=" border-[#FF014F]/20 rounded bg-gradient-to-r flex items-center justify-between from-[#433a3d1e] to-[#dad7d809] backdrop-blur-sm p-8 md:p-12">
                        <div className="">
                            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
                                ডাউনলোড করুন আমাদের মোবাইল অ্যাপ
                            </h3>
                            <p className="text-gray-400 text-lg mb-8  ">
                                আমাদের বিশেষজ্ঞ-নির্দেশিত কোর্স এবং বিস্তৃত সহায়তা ব্যবস্থার সাথে আপনার সাফল্যের পথ সুগম করুন
                            </p>
                            <div className=" ">

                                <a href='https://sohayokedu.com/apk/sohayok.apk' download='sohayok.apk' className="px-8 py-4 bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-600 hover:to-gray-700 text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 border border-gray-600 hover:border-gray-500 text-lg">
                                    <i className="fa-brands fa-android mr-2"></i>  ফ্রী কনসাল্টেশন
                                </a>
                            </div>
                        </div>

                        <div className='hidden md:block'>
                            <img className='h-60' src="https://cdn-icons-png.flaticon.com/512/8263/8263246.png" alt="" />
                        </div>
                    </div>
                </div>
