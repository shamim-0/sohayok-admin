...
export default function Instructors({ instructors, instructorcontent }) {
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {instructors.map((instructor) => (
                            <div
                                key={instructor.id}
                                className="group relative bg-[#857f7f10] backdrop-blur-sm rounded-2xl overflow-hidden shadow-2xl  cursor-pointer p-6"
                            >
                                {/* Status Indicator */}
