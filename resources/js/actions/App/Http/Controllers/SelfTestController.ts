...
/**
* @see \App\Http\Controllers\SelfTestController::submit_exam
...
/**
* @see \App\Http\Controllers\SelfTestController::show_result
 * @see app/Http/Controllers/SelfTestController.php:80
 * @route '/self/result/{id}'
 */
export const show_result = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: show_result.url(args, options),
    method: 'get',
})

show_result.definition = {
    methods: ["get","head"],
    url: '/self/result/{id}',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/self/result/{id}'
 */
show_result.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { id: args }
    }
    ...
    return show_result.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/self/result/{id}'
 */
show_result.get = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: show_result.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/self/result/{id}'
 */
show_result.head = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: show_result.url(args, options),
    method: 'head',
})
 ...
 * @route '/self/result/{id}'
 */
    const show_resultForm = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: show_result.url(args, options),
        method: 'get',
    })
 ...
 * @route '/self/result/{id}'
 */
        show_resultForm.get = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: show_result.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/self/result/{id}'
 */
        show_resultForm.head = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: show_result.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    show_result.form = show_resultForm
const SelfTestController = { index, subject, start_exam, submit_exam, show_result }
