...
/**
* @see \App\Http\Controllers\OrderManageController::updateStatus
 * @see app/Http/Controllers/OrderManageController.php:76
 * @route '/admin/panel/orders/{order}/status'
 */
...
updateStatus.definition = {
    methods: ["post"],
    url: '/admin/panel/orders/{order}/status',
} satisfies RouteDefinition<["post"]>
 ...
 * @route '/admin/panel/orders/{order}/status'
 */
        updateStatusForm.post = (args: { order: number | { id: number } } | [order: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: updateStatus.url(args, options),
            method: 'post',
        })
    
    updateStatus.form = updateStatusForm
const OrderManageController = { index, create, store, show, edit, update, destroy, updateStatus }
