 ...
 */
    ...
    add.form = addForm
/**
* @see \App\Http\Controllers\QuestionController::importPage
...
const QuestionController = { index, add, importPage, store, importMethod, update, destroy, import: importMethod }
