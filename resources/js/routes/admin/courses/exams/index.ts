...
/**
* @see \App\Http\Controllers\Admin\ExamController::grade
 * @see app/Http/Controllers/Admin/ExamController.php:121
 * @route '/admin/courses/{course}/exams/{exam}/submissions/{submission}/grade'
 */
export const grade = (args: { course: number | { id: number }, exam: number | { id: number }, submission: number | { id: number } } | [course: number | { id: number }, exam: number | { id: number }, submission: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/admin/courses/{course}/exams/{exam}/submissions/{submission}/grade'
 */
grade.url = (args: { course: number | { id: number }, exam: number | { id: number }, submission: number | { id: number } } | [course: number | { id: number }, exam: number | { id: number }, submission: number | { id: number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    course: args[0],
                    exam: args[1],
 ...
 * @route '/admin/courses/{course}/exams/{exam}/submissions/{submission}/grade'
 */
grade.post = (args: { course: number | { id: number }, exam: number | { id: number }, submission: number | { id: number } } | [course: number | { id: number }, exam: number | { id: number }, submission: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: grade.url(args, options),
    method: 'post',
})
 ...
 * @route '/admin/courses/{course}/exams/{exam}/submissions/{submission}/grade'
 */
    const gradeForm = (args: { course: number | { id: number }, exam: number | { id: number }, submission: number | { id: number } } | [course: number | { id: number }, exam: number | { id: number }, submission: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/courses/{course}/exams/{exam}/submissions/{submission}/grade'
 */
        gradeForm.post = (args: { course: number | { id: number }, exam: number | { id: number }, submission: number | { id: number } } | [course: number | { id: number }, exam: number | { id: number }, submission: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: grade.url(args, options),
            method: 'post',
        })
