    ...
    <div class="mx-auto px-4 py-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div class="mb-4 md:mb-0">
                ...
                <p class="text-gray-600 mt-1">আপনার রিভিউ পেজ সেকশন টাইটেল এবং সাবটাইটেল ম্যানেজ করুন</p>
            </div>
        </div>
        ...
        <!-- Review Page Section Content Form -->
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200">
                <h5 class="text-lg font-semibold text-gray-900">রিভিউ পেজ সেকশন কন্টেন্ট</h5>
                <p class="text-sm text-gray-600 mt-1">আপনার রিভিউ পেজ সেকশনের টাইটেল এবং সাবটাইটেল সেট করুন</p>
            </div>

            <div class="p-6">
                <form action="{{ route('admin.review-page-section.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="title_part_1" name="title_part_1" 
                                   value="{{ old('title_part_1', $reviewPageSection->title_part_1 ?? '') }}" 
                                   required
                        ...
                        <div>
                            ...
                            <input type="text" id="title_part_2" name="title_part_2" 
                                   value="{{ old('title_part_2', $reviewPageSection->title_part_2 ?? '') }}" 
                                   required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                        ...
                        <div>
                            ...
                            <input type="text" id="subtitle_part_1" name="subtitle_part_1" 
                                   value="{{ old('subtitle_part_1', $reviewPageSection->subtitle_part_1 ?? '') }}" 
                                   required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                        ...
                        <div>
                            ...
                            <input type="text" id="subtitle_part_2" name="subtitle_part_2" 
                                   value="{{ old('subtitle_part_2', $reviewPageSection->subtitle_part_2 ?? '') }}" 
                                   required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                    ...
                    <div class="mb-6 p-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-200">
                        <h4 class="text-sm font-medium text-gray-900 mb-4 text-center">রিভিউ পেজ সেকশন - লাইভ প্রিভিউ</h4>
                        
                        <!-- Title Preview -->
                        <div class="text-center mb-4">
                            <h2 class="text-2xl md:text-3xl font-bold text-gray-900">
                                <span id="preview-title-part-1" class="text-gray-800">
                                    {{ old('title_part_1', $reviewPageSection->title_part_1 ?? 'শিক্ষার্থীদের') }}
                                </span>
                                <span id="preview-title-part-2" class="text-purple-600">
                                    {{ old('title_part_2', $reviewPageSection->title_part_2 ?? 'মতামত') }}
                                </span>
                            </h2>
                        </div>
                        ...
                        <div class="text-center">
                            <p class="text-lg text-gray-600">
                                <span id="preview-subtitle-part-1">
                                    {{ old('subtitle_part_1', $reviewPageSection->subtitle_part_1 ?? 'আমাদের শিক্ষার্থীদের') }}
                                </span>
                                <span id="preview-subtitle-part-2" class="font-semibold text-purple-500">
                                    {{ old('subtitle_part_2', $reviewPageSection->subtitle_part_2 ?? 'বাস্তব অভিজ্ঞতা শুনুন') }}
                                </span>
                            </p>
                        </div>
        ...
        @if($reviewPageSection)
            <div class="mt-6 bg-purple-50 rounded-lg border border-purple-200 p-6">
                ...
                <div class="mt-3 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-purple-700">
                    <div>
                        <p><strong>টাইটেল পার্ট ১:</strong> {{ $reviewPageSection->title_part_1 }}</p>
                        <p><strong>টাইটেল পার্ট ২:</strong> {{ $reviewPageSection->title_part_2 }}</p>
                    </div>
                    <div>
                        <p><strong>সাবটাইটেল পার্ট ১:</strong> {{ $reviewPageSection->subtitle_part_1 }}</p>
                        <p><strong>সাবটাইটেল পার্ট ২:</strong> {{ $reviewPageSection->subtitle_part_2 }}</p>
                    </div>
                </div>
                <div class="mt-3 text-xs text-purple-600">
                    <p><strong>সর্বশেষ আপডেট:</strong> {{ $reviewPageSection->updated_at->format('d M, Y H:i') }}</p>
                </div>
            </div>
        @else
            <div class="mt-6 bg-yellow-50 rounded-lg border border-yellow-200 p-6">
                ...
                <p class="mt-2 text-sm text-yellow-700">
                    আপনার রিভিউ পেজ সেকশনে কোন কন্টেন্ট সেট করা নেই। উপরের ফর্ম ব্যবহার করে টাইটেল এবং সাবটাইটেলের অংশগুলো যোগ করুন।
                </p>
            </div>
        @endif
    </div>
