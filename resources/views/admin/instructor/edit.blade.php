...
<div class="flex-1 p-6 overflow-y-auto">
    ...
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-8">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">শিক্ষক সম্পাদনা করুন</h1>
            <p class="text-gray-600 mt-1">{{ $instructor->name }} - এর তথ্য আপডেট করুন</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="education" id="education" value="{{ old('education', $instructor->education) }}"
                           class="w-full bg-gray-50 border border-gray-300 rounded-xl px-4 py-3 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300">
                    @error('education')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex flex-col md:flex-row gap-4 items-start">
                        ...
                        <div class="flex-shrink-0">
                            <img src="{{ $instructor->image_url }}" alt="Current Image" 
                            ...
                            <div class="mt-2 text-center">
                                <label class="inline-flex items-center text-sm text-gray-600">
                                    ...
                                    <span class="ml-2">ছবি মুছুন</span>
                                </label>
                            </div>
                        </div>
                        @endif
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="bio" id="bio" rows="4"
                              class="w-full bg-gray-50 border border-gray-300 rounded-xl px-4 py-3 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300">{{ old('bio', $instructor->bio) }}</textarea>
                    @error('bio')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <select name="is_active" id="is_active"
                        ...
                        <option value="1" {{ old('is_active', $instructor->is_active) ? 'selected' : '' }}>সক্রিয়</option>
                        <option value="0" {{ !old('is_active', $instructor->is_active) ? 'selected' : '' }}>নিষ্ক্রিয়</option>
                    </select>
                    @error('is_active')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
