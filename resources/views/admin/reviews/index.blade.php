    ...
    <div class=" mx-auto px-4 py-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div class="mb-4 md:mb-0">
                ...
                <p class="text-gray-600  mt-1">Manage student reviews and testimonials</p>
            </div>
        ...
        <div class="bg-white  rounded-lg shadow-sm border border-gray-200 ">
            <div class="px-6 py-4 border-b border-gray-200  flex justify-between items-center">
                <div>
                    <h5 class="text-lg font-semibold text-gray-900 ">All Reviews</h5>
                    <p class="text-sm text-gray-600  mt-1">Drag to reorder reviews</p>
                </div>
            ...
            <div class="p-6">
                @if($reviews->count() > 0)
                    <div id="reviews-list" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        @foreach($reviews as $review)
                            <div class="review-item bg-white  rounded-lg border border-gray-200  transition-all duration-200 hover:shadow-md group"
                                    ...
                                    <div class="flex items-start justify-between mb-4">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-600 ">{{ $review->school_college }}</p>
                                            </div>
                                        </div>
                                        <div class="drag-handle cursor-move text-gray-400 hover:text-gray-600  transition-colors duration-200 p-1 rounded hover:bg-gray-100 ">
                                    ...
                                    <div class="flex items-center justify-between pt-4 border-t border-gray-200 ">
                                        ...
                                        <div class="flex items-center space-x-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                            ...
                                            <a href="{{ route('admin.reviews.edit', $review) }}" 
                                               class="p-1 text-blue-600 hover:text-blue-800  transition duration-150"
                                               title="Edit">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <!-- Toggle Status -->
                                            <form action="{{ route('admin.reviews.toggle-status', $review) }}" method="POST" class="inline">
                                                @csrf
                                                <button type="submit" 
                                                        class="p-1 text-yellow-600 hover:text-yellow-800 transition duration-150"
                                            ...
                                            <!-- Delete -->
                                            <button onclick="confirmDelete({{ $review->id }}, '{{ addslashes($review->name) }}')" 
                                                    class="p-1 text-red-600 hover:text-red-800  transition duration-150"
                                                    title="Delete">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-500  mb-6">Get started by adding your first student review.</p>
                        <a href="{{ route('admin.reviews.create') }}" 
                           class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition duration-200">
                            Add Review
                        </a>
        ...
        <div class="bg-white  rounded-lg shadow-xl max-w-md w-full">
            <div class="p-6">
                ...
                <div class="text-center">
                    <h3 class="text-lg font-semibold text-gray-900  mb-2">Delete Review</h3>
                    <p class="text-gray-600  mb-4">
                        Are you sure you want to delete review from "<span id="deleteReviewName" class="font-semibold"></span>"?
                    </p>
...
<script>
// Delete Functions
function confirmDelete(reviewId, name) {
    document.getElementById('deleteReviewName').textContent = name;
    document.getElementById('deleteForm').action = `{{ url('admin/panel/reviews') }}/${reviewId}`;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (reviewsList) {
        const sortable = new Sortable(reviewsList, {
            handle: '.drag-handle',
            animation: 150,
        ...
        function updateReviewOrder() {
            ...
            const reviewIds = Array.from(reviewItems).map(item => 
            ...
            fetch('{{ route("admin.reviews.update-order") }}', {
                method: 'POST',
                headers: {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    showTempMessage('Review order updated successfully!', 'success');
                } else {
            ...
            .catch(error => {
                ...
                showTempMessage('Error updating review order!', 'error');
            });
        }
