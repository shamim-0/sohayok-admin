    ...
    <div class=" mx-auto px-4 py-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div class="mb-4 md:mb-0">
                <h1 class="text-2xl font-bold text-gray-900 ">Add New Review</h1>
                <p class="text-gray-600  mt-1">Create a new student review</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="school_college" name="school_college" value="{{ old('school_college') }}" required
                                       class="w-full px-3 py-2 border border-gray-300  rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500  "
                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="ml-2 text-sm font-medium text-gray-600 ">
                                        <span id="current-rating">{{ old('rating', 5) }}</span>/5
                                    </span>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea id="comment" name="comment" rows="5" required
                                          class="w-full px-3 py-2 border border-gray-300  rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500  "
                                          placeholder="Enter the review comment (minimum 10 characters)">{{ old('comment') }}</textarea>
                                <div class="flex justify-between text-xs text-gray-500 mt-1">
                                    <span>Minimum 10 characters</span>
                                    <span id="charCount">{{ strlen(old('comment', '')) }}/1000</span>
                                </div>
                            </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-gray-50  rounded-lg p-4 border border-gray-200 ">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <h5 id="preview-name" class="font-semibold text-gray-900 ">Student Name</h5>
                                            <p id="preview-school" class="text-sm text-gray-600 ">School/College</p>
                                        </div>
                                    </div>
                                    ...
                                    <div id="preview-rating" class="flex items-center space-x-1">
                                        ...
                                        @endfor
                                        <span class="text-sm text-gray-600  ml-1">5.0/5</span>
                                    </div>
                            ...
                            <div class="bg-blue-50  rounded-lg p-4 border border-blue-200 ">
                                <h4 class="text-sm font-medium text-blue-900  mb-2">Tips for Great Reviews</h4>
                                <ul class="text-xs text-blue-700  space-y-1">
                                    <li>• Use real student names and schools</li>
                                    <li>• Keep comments genuine and detailed</li>
                                    <li>• Choose appropriate ratings (3-5 stars)</li>
                                    <li>• Upload clear profile photos</li>
                                    <li>• Keep comments between 50-200 characters</li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePreview() {
        ...
        ratingText.textContent = `${selectedRating}.0/5`;
