    ...
    <div class="mx-auto px-4 py-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div class="mb-4 md:mb-0">
                ...
                <p class="text-gray-600 mt-1">আপনার ক্যাটাগরি সেকশন টাইটেল এবং সাবটাইটেল ম্যানেজ করুন</p>
            </div>
        </div>
        ...
        <!-- Category Section Content Form -->
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200">
                <h5 class="text-lg font-semibold text-gray-900">ক্যাটাগরি সেকশন কন্টেন্ট</h5>
                <p class="text-sm text-gray-600 mt-1">আপনার ক্যাটাগরি সেকশনের টাইটেল এবং সাবটাইটেল সেট করুন</p>
            </div>

            <div class="p-6">
                <form action="{{ route('admin.category-section.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="title_part_1" name="title_part_1" 
                                   value="{{ old('title_part_1', $categorySection->title_part_1 ?? '') }}" 
                                   required
                        ...
                        <div>
                            ...
                            <input type="text" id="title_part_2" name="title_part_2" 
                                   value="{{ old('title_part_2', $categorySection->title_part_2 ?? '') }}" 
                                   required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div>
                            ...
                            <input type="text" id="subtitle_part_1" name="subtitle_part_1" 
                                   value="{{ old('subtitle_part_1', $categorySection->subtitle_part_1 ?? '') }}" 
                                   required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div>
                            ...
                            <input type="text" id="subtitle_part_2" name="subtitle_part_2" 
                                   value="{{ old('subtitle_part_2', $categorySection->subtitle_part_2 ?? '') }}" 
                                   required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    ...
                    <div class="mb-6 p-6 bg-gray-50 rounded-lg border border-gray-200">
                        <h4 class="text-sm font-medium text-gray-900 mb-4">লাইভ প্রিভিউ</h4>
                        
                        <!-- Title Preview -->
                        <div class="text-center mb-6">
                            <h2 class="text-2xl md:text-4xl font-bold text-gray-900">
                                <span id="preview-title-part-1" class="text-gray-800">
                                    {{ old('title_part_1', $categorySection->title_part_1 ?? 'আপনার টাইটেল পার্ট ১') }}
                                </span>
                                <span id="preview-title-part-2" class="text-blue-600">
                                    {{ old('title_part_2', $categorySection->title_part_2 ?? 'আপনার টাইটেল পার্ট ২') }}
                                </span>
                            </h2>
                        </div>
                        ...
                        <div class="text-center">
                            <p class="text-lg text-gray-600">
                                <span id="preview-subtitle-part-1">
                                    {{ old('subtitle_part_1', $categorySection->subtitle_part_1 ?? 'আপনার সাবটাইটেল পার্ট ১') }}
                                </span>
                                <span id="preview-subtitle-part-2" class="font-semibold">
                                    {{ old('subtitle_part_2', $categorySection->subtitle_part_2 ?? 'আপনার সাবটাইটেল পার্ট ২') }}
                                </span>
                            </p>
                        </div>
                        ...
                        <div class="mt-4 p-4 bg-white rounded border">
                            <h5 class="text-sm font-medium text-gray-700 mb-2">সম্পূর্ণ টেক্সট:</h5>
                            <p class="text-gray-600">
                                <strong>টাইটেল:</strong> 
                                "<span id="preview-full-title">
                                    {{ old('title_part_1', $categorySection->title_part_1 ?? 'আপনার টাইটেল পার্ট ১') }}
                                    {{ old('title_part_2', $categorySection->title_part_2 ?? 'আপনার টাইটেল পার্ট ২') }}
                                </span>"
                            </p>
                            <p class="text-gray-600 mt-1">
                                <strong>সাবটাইটেল:</strong> 
        ...
        @if($categorySection)
            <div class="mt-6 bg-green-50 rounded-lg border border-green-200 p-6">
                ...
                <div class="mt-3 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-green-700">
                    <div>
                        <p><strong>টাইটেল পার্ট ১:</strong> {{ $categorySection->title_part_1 }}</p>
                        <p><strong>টাইটেল পার্ট ২:</strong> {{ $categorySection->title_part_2 }}</p>
                    </div>
                    <div>
                        <p><strong>সাবটাইটেল পার্ট ১:</strong> {{ $categorySection->subtitle_part_1 }}</p>
                        <p><strong>সাবটাইটেল পার্ট ২:</strong> {{ $categorySection->subtitle_part_2 }}</p>
                    </div>
                </div>
                <div class="mt-3 text-xs text-green-600">
                    <p><strong>সর্বশেষ আপডেট:</strong> {{ $categorySection->updated_at->format('d M, Y H:i') }}</p>
                </div>
            </div>
        @else
            <div class="mt-6 bg-yellow-50 rounded-lg border border-yellow-200 p-6">
                ...
                <p class="mt-2 text-sm text-yellow-700">
                    আপনার ক্যাটাগরি সেকশনে কোন কন্টেন্ট সেট করা নেই। উপরের ফর্ম ব্যবহার করে টাইটেল এবং সাবটাইটেলের অংশগুলো যোগ করুন।
                </p>
            </div>
        @endif
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePreview() {
        ...
        document.getElementById('preview-title-part-1').textContent = 
            titlePart1Input.value || 'আপনার টাইটেল পার্ট ১';
        
        // Title Part 2
        document.getElementById('preview-title-part-2').textContent = 
            titlePart2Input.value || 'আপনার টাইটেল পার্ট ২';
        
        // Subtitle Part 1
        document.getElementById('preview-subtitle-part-1').textContent = 
            subtitlePart1Input.value || 'আপনার সাবটাইটেল পার্ট ১';
        
        // Subtitle Part 2
        document.getElementById('preview-subtitle-part-2').textContent = 
            subtitlePart2Input.value || 'আপনার সাবটাইটেল পার্ট ২';
